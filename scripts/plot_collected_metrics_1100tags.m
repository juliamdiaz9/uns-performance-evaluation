%% plot_collected_metrics_1100tags.m
% =========================================================================
% EMQX Cloud – Parris vs Schultz Method Comparison (1100 tags)
% =========================================================================
%
% Description:
%   Reads the processed CSV (collected_metrics_1100tags_processed.csv) and
%   generates one figure per metric, overlaying Parris Method (22 sessions)
...
%
% Input:
%   C:\Users\John Arenas\Desktop\data\uns-performance-evaluation\data\processed\collected_metrics_1100tags_processed.csv
%
% Output:
...
%% Path
csvFile = 'C:\Users\John Arenas\Desktop\data\uns-performance-evaluation\data\processed\collected_metrics_1100tags_processed.csv';
